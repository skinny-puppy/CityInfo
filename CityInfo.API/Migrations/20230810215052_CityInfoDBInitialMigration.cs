    ...
    public partial class CityInfoDBInitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "The one with that big park.", "New York City" },
                    { 2, 2, "The one with the cathedral that was never really finished.", "Antwerp" },
                    { 3, 3, "The one with that big tower.", "Paris" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 2, "A Gothic style cathedral, concieved by architects Jan and Piete.", "Cathedral of Our Lady" },
